...
to check if the last bit set to one we do `n & 1 = 1` it means it set else not set
...
**In this you are given the Number n = number we need to reomve the right Most set Bit**
